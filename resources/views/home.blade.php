  ...
  <div class="col-md-6">
      <img class="animated slideInRight" src="../images/qrcode.jpg" style="width: 100%; height: 54%;padding-top:50px;">
        ...
        <div class="col-md-12">
            ...
            <hr>
        <p style="font-size:24px; text-shadow: 2px 2px #000;">Desenvolvedores:</p>
        <br />
          <div class="col-md-6">
            <img src="../images/desenvolvedores/Caio.jpg" alt="Caio Melo" height="70%" width="70%" style="border-radius: 250px;">
            <br />
            <h3 style="text-shadow: 2px 2px #000;">Caio Melo</h3>
            <p align="justify " style="font-size:17px; text-shadow: 2px 2px #000;">Nascido na cidade de Mogi Mirim-SP, tem 17 anos, está cursando o último ano 
          ...
          <div class="col-md-6">
            <img src="../images/desenvolvedores/Gui.jpg" alt="Guilherme Oliveira" height="70%" width="70%" style="border-radius: 250px;">
            <br />
            <h3 style="text-shadow: 2px 2px #000;">Guilherme Lombardi</h3>
            <p align="justify" style="font-size:17px; text-shadow: 2px 2px #000;">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi tempus dolor ac orci rutrum, et gravida urna pretium. Duis sagittis dolor quam, non varius massa consectetur et. Cras sit amet lorem nisi. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Cras non massa ante. Aliquam tempor elit a dictum facilisis.</p>
          </div>
          <div class="col-md-6">
            <img src="../images/desenvolvedores/Manera.jpg" alt="Lucas Manera" height="70%" width="70%" style="border-radius: 250px;">
            <br />
            <h3 style="text-shadow: 2px 2px #000;">Lucas Manera</h3>
            <p align="justify" style="font-size:17px; text-shadow: 2px 2px #000;">Nascido na cidade de Mogi Mirim-SP, tem 17 anos, está cursando o último ano 
            do curso técnico de Informática para Internet da ETEC Pedro Ferreira Alves. Torce para o Sport 
            Clube Corinthians Paulista, responsável pela parte de Design do projeto QR Security. Tem como objetivo 
          ...
          <div class="col-md-6">
            <img src="../images/desenvolvedores/Sasa.jpg" alt="Lucas Sartorelli" height="70%" width="70%" style="border-radius: 250px;">
            <br />
            <h3 style="text-shadow: 2px 2px #000;">Lucas Sartorelli</h3>
            <p align="justify" style="font-size:17px;text-shadow: 2px 2px #000;" >Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi tempus dolor ac orci rutrum, et gravida urna pretium. Duis sagittis dolor quam, non varius massa consectetur et. Cras sit amet lorem nisi. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Cras non massa ante. Aliquam tempor elit a dictum facilisis.</p>
          </div>
          <div class="col-md-6">
            <img src="../images/desenvolvedores/Matheus.jpg" alt="Matheus Oliveira" height="70%" width="70%" style="border-radius: 250px;">
            <br />
            <h3 style="text-shadow: 2px 2px #000;">Matheus Oliveira</h3>
            <p align="justify" style="font-size:17px; text-shadow: 2px 2px #000;">Nascido na cidade de Conchal-SP, tem 17 anos e está cursando o último
          ...
          <div class="col-md-6">
            <img src="../images/desenvolvedores/Max.jpg" alt="Maxwell Arruda" height="70%" width="70%" style="border-radius: 250px;">
            <br />
            <h3 style="text-shadow: 2px 2px #000;">Maxwell Arruda</h3>
            <p align="justify" style="font-size:17px; text-shadow: 2px 2px #000;">Nascido na cidade de Varginha-MG, tem 17 anos, mudou-se para Mogi Mirim-SP em 2010 e está cursando o último
            ano do curso técnico de Informática para a Internet na ETEC Pedro Ferreira Alves, torce para o São Paulo Futebol Clube. Iniciou
            neste ano os estudos em Laravel, mas ainda está indeciso em qual faculdade fazer.</p>
          </div>
          <div class="col-md-6 col-md-offset-3">
            <img src="../images/desenvolvedores/Wil.jpg" alt="Wilgner Delfino" height="70%" width="70%" style="border-radius: 250px;">
            <br />
            <h3 style="text-shadow: 2px 2px #000;">Wilgner Delfino</h3>
            <p align="justify" style="font-size:17px; text-shadow: 2px 2px #000;">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi tempus dolor ac orci rutrum, et gravida urna pretium. Duis sagittis dolor quam, non varius massa consectetur et. Cras sit amet lorem nisi. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Cras non massa ante. Aliquam tempor elit a dictum facilisis.</p>
          </div>
          </div>
        </div>
