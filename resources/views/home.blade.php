...
@section('content')
  ...
  <div class="col-md-6 well2 animated slideInLeft">
    <h1 class="animated slideInLeft" style="color: #000;">O Que é o QR Security?</h1>
      <p class="text-justify animated slideInLeft" style="font-size:17px; color: #000;">
